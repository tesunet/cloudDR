   var Activate = function () {
    ...
    $(document).ready(function() {
        ...
        $('#sample_1 tbody').on( 'click', 'button#edit', function () {
                ...
                $("#spec_time").val(data.spec_time);
                $("#spec_size").val(data.spec_size);
                $("#spec_perform").val(data.spec_perform);
